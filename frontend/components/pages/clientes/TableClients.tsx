  ...
  export function TableViewClient({ customers }: CustomersList) {
    ...
    return (
      <div className="rounded-md border">
        ...
        <UpdateClient open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen} customer={currentCustomer} />
  
        {/* Dialog para visualizar detalhes do cliente */}
        <ViewDetails open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen} customer={currentCustomer} />
      </div>
    );
  }
