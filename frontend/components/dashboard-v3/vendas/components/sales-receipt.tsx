  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="p-4 bg-white rounded-md border" ref={printRef}>
          {/* Cabeçalho da loja */}
          <div className="text-center mb-4">
            <h2 className="text-xl font-bold">{STORE_NAME}</h2>
            <p className="text-sm text-gray-500">CNPJ: {STORE_CNPJ}</p>
            <p className="text-sm text-gray-500">{STORE_ADDRESS}</p>
            <p className="text-sm text-gray-500">{STORE_PHONE}</p>
          </div>
